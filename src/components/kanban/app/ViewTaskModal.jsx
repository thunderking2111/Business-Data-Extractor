...
const ViewTaskModal = ({ task, open, onClose }) => {
    ...
    const onColumnNameChange = (newColumn) => {
        if (newColumn) {
            dispatch(
                taskMoved({
                    task,
    ...
    return (
        <>
            ...
            >
                ...
                <div className="body-lg mb-[24px] text-medium-gray">{task.description}</div>
                ...
                <div className="flex w-full flex-col gap-[8px]">
                    {task.subtasks.map((subtask, i) => (
                        ...
                        >
                            ...
                            >
                                {subtask.completed && <img src={Check} alt="" />}
                            </Switch>
                            <div
                ...
                <div className="body-md mb-[8px] mt-[24px] text-medium-gray">Current Status</div>
                <Listbox
                ...
                >
                    <div className="relative">
                        <Listbox.Button className="font-body-lg flex h-[40px] w-full items-center justify-between rounded border border-medium-gray px-[16px] py-[8px] text-left text-[13px] leading-[23px] dark:text-white">
                            <div>{activeColumns.find((col) => col.id === task.column)?.title}</div>
